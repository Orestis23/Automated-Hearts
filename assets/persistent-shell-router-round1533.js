/* Automated Hearts Round 1533 — persistent shell router with current-route cache authority.
...
(() => {
  ...
  const pages = {
    ...
    solutions: {
      ...
      shieldQuote:'The Negative-Software Solution'
    },
    'who-we-help': {
  ...
  document.addEventListener('click', (event) => {
    ...
    /* Round 1536: Learning Center / Industries model controls are same-document
