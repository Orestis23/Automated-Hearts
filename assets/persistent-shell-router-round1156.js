...
(() => {
  ...
  addEventListener('message', (event) => {
    ...
    if (data.type === 'ah:shell-route' && typeof data.href === 'string') {
      navigate(data.href, {push:true});
    } else if (data.type === 'ah:shell-contact') {
