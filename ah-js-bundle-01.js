        ...
        >
          ...
          >
            <label class="nav-contact-field">
              ...
              <input class="ah-red-screen" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" autocomplete="name" name="name" placeholder="Name (required)" required type="text">
            </label>
            <label class="nav-contact-field">
              <span class="sr-only">Email</span>
              <input class="ah-red-screen" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" autocomplete="email" name="email" placeholder="Email (required)" required type="email">
            </label>
<label class="nav-contact-field nav-contact-field--full ah-phone-field"><span class="sr-only">Phone number (required)</span><input class="ah-red-screen" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" autocomplete="tel" inputmode="tel" name="phone" placeholder="Phone number (required)" required type="tel"></label>
            <label class="nav-contact-field">
              <span class="sr-only">Business or organization</span>
              <input class="ah-red-screen" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" autocomplete="organization" name="business" placeholder="Business or organization" type="text">
            </label>
            <label class="nav-contact-field">
              <span class="sr-only">Business type</span>
              <select class="ah-red-screen" data-ah-placeholder-select="1" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" aria-label="Business type" name="business_type">
            ...
            <label class="nav-contact-field nav-contact-field--full">
              ...
              <textarea class="ah-red-screen" style="background:linear-gradient(180deg,#ad1027 0%,#7f081b 46%,#4c030f 100%)!important;color:#8fffd7!important;-webkit-text-fill-color:#8fffd7!important;font-family:"Orbitron",system-ui,sans-serif!important;" name="message" placeholder="What feels harder than it should?" required rows="4"></textarea>
            </label>
    ...
    drawer.querySelectorAll("select[data-ah-placeholder-select]").forEach((select) => {
      const syncSelectColor = () => {
        const color = select.value ? "#8fffd7" : "#ffffff";
