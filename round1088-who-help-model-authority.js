...
(()=>{
  'use strict';
  if(window.__AH1088WhoHelpModelAuthority) return;
  ...
  const activate=(n,{scroll=false,force=false}={})=>{
    ...
    if(frame){
      ...
      for(const [p,v] of [['display','block'],['visibility','visible'],['opacity','1'],['pointer-events','auto'],['background','transparent'],['background-color','transparent'],['background-image','none'],['transform','none']])imp(frame,p,v);
    ...
    [60,180,420,900,1600,2800].forEach(ms=>setTimeout(()=>{
      ...
      if(frame)for(const [p,v] of [['display','block'],['visibility','visible'],['opacity','1'],['pointer-events','auto'],['background','transparent'],['background-color','transparent'],['background-image','none'],['transform','none']])imp(frame,p,v);
